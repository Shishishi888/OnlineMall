/*
 ...
 Source Schema         : onlinemall_wms

 Target Server Type    : MySQL
 Target Server Version : 50736
 File Encoding         : 65001

 Date: 22/07/2022 23:05:51
*/
...
CREATE TABLE `wms_purchase`  (
  ...
  `phone` char(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '采购信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wms_ware_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '仓库信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wms_ware_sku`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '商品库存' ROW_FORMAT = Dynamic;
